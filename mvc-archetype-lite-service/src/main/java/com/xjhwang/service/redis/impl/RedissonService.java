package com.xjhwang.service.redis.impl;

import com.xjhwang.service.redis.IRedisService;
 ...
 * 基于Redisson的Redis服务
 *
 * @author 黄雪杰 on 2024-06-11 18:16
 */
@Slf4j
@Service
public class RedissonService implements IRedisService {
    ...
    @Override
    public Boolean setNx(String key, long expiration, TimeUnit timeUnit) {
        
        return redissonClient.getBucket(key).setIfAbsent("lock", Duration.ofMillis(timeUnit.toMillis(expiration)));
    }
}
